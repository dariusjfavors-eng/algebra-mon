...
export const PROFESSOR_ROUTE = [
  { label: "Unit1", offset: { x: -60, y: -30 } },
  { label: "Unit1B", offset: { x: 80, y: 20 } },
  { label: "Unit2", offset: { x: -40, y: 0 }, gymIndex: 1 },
  { label: "Unit1C", offset: { x: 20, y: -50 } }
];
